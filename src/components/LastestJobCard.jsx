...
const LastestJobCard = ({job}) => {
  ...
  return (
    <div onClick={() => navigate(`/jobs/${job._id}`)} className="p-6 rounded-xl shadow-lg bg-white border border-gray-200 cursor-pointer transition hover:shadow-2xl text-left">
      <div className="mb-2">
